...
//++ fix the imgs url again
    ?>
        <div class="fct1-tile-one">
            <a href="<?php echo isset( $prefix ) ? $prefix : '' ?><?php echo $meta_value ?>"<?php echo isset( $attrs ) ? $attrs : '' ?> title="<?php echo $img ?>"></a>
            <img width="100" height="80" src="/wp-content/plugins/forms-klinikerfahrungen/forms/entity-add/templates/imgs/<?php echo $img ?>.svg" class="attachment-full size-full" alt="" loading="lazy">
