...
//++ fix the imgs url again
    ?>
        <div class="fct1-tile-one">
            ...
            <img width="100" height="80" src="/wp-content/plugins/wp-fcp-forms/forms/entity-add/templates/imgs/<?php echo $img ?>.svg" class="attachment-full size-full" alt="" loading="lazy">
