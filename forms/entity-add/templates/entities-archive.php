...
if ( $args['meta_query'] && $wp_query->post_count < 7 ) {
    ...
    fcLoadScriptVariable( '/wp-content/plugins/forms-klinikerfahrungen/forms/entity-add/templates/assets/load-in-radius.js', 'fcFoundInRadius', () => {
        fcLoadScriptVariable( '/wp-content/plugins/forms-klinikerfahrungen/forms/entity-add/templates/assets/load-in-search.js' );
    }, ['jQuery'] );
    </script>
    <?php
}
